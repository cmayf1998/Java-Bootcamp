...
public class Exercises {
	...
	public String stringTimes(String str, int n) {
		String value = ""; // create a string
		for (int i = 0; i < n; i++) { //want to continue loop until i < n
			value = value + str;
		}
		return value;
	}
	...
	/*	String x = "";
		...
		//Struggled to get the str.charAt to work in this problem. Will be revisiting after submitting


	/*;a new string made of every other char starting with the first, so "Hello" yields "Hlo".
	...
	public String stringX(String str) {
		...
		return null;
	} //Also struggled with this one and will be revisiting. Feedback much appreciated!
	...
	public String stringYak(String str) {
		String value = "";
		for (int i = 0; i < str.length(); i++) {
			if (str.charAt(i) == 'y' && str.charAt(i + 1) == 'k') {
				i = i + 2;
			} else {
				value += str.charAt(i);
			}
...
//Also struggled with this one, will be trying to get it and I really appreciate feedback!
